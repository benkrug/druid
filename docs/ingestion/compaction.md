...
|`rollup`|Whether to enable ingestion-time rollup or not. Defaults to 'null', which preserves the original setting. Note that once data is rolled up, individual records can no longer be recovered. |No|
